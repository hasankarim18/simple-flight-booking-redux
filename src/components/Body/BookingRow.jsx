...
import { deleteBooking } from "../../redux/bookflight/actionCreators";



const BookingRow = ({ detail }) => {
 ...
 const deleteHandler = (id)=> {
  ...
  const {from, date, to,id,  ticketClass,  guests} = detail;
  return (
    <tr className="lws-bookedTable text-black">
      <td>
        <p className="lws-bookedFrom ml-2">{id}</p>
      </td>
